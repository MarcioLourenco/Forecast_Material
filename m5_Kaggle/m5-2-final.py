...
def get_base_test():
    ...
    for store_id in STORES_IDS:
        temp_df = pd.read_pickle('Data/test_'+store_id+'.pkl')
...
for store_id in STORES_IDS:
    ...
    grid_df.to_pickle('Data/test_'+store_id+'.pkl')
    del grid_df
    ...
    model_name = 'Data/lgb_model_'+store_id+'_v'+str(VER)+'.bin'
...
for PREDICT_DAY in range(1,29):    
    ...
    for store_id in STORES_IDS:
        ...
        model_path = 'Data/lgb_model_'+store_id+'_v'+str(VER)+'.bin' 
...
submission.to_csv('Data/submission_v'+str(VER)+'.csv', index=False)